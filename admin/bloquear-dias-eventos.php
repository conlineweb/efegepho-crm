...
$query = "SELECT * FROM dias_bloqueados_eventos";
...
<head>
    ...
    <title>Bloquear d&iacute;as de eventos</title>
...
td.disabled {
 ...
 td.blocked {
    ...
    <h3 class="">Bloqueo de d&iacute;as de eventos</h3><br>
    ...
    if (isBlocked) {
        Swal.fire({
            ...
            if (willUnlock.isConfirmed) {
                $.ajax({
                    url: "bloqueo_fechas_eventos.php",
                    method: "POST",
