...
if (isset($_POST['fecha'])) {
    ...
    $query = "SELECT * FROM dias_bloqueados_eventos WHERE fecha = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $deleteQuery = "DELETE FROM dias_bloqueados_eventos WHERE fecha = ?";
        ...
        $insertQuery = "INSERT INTO dias_bloqueados_eventos (fecha) VALUES (?)";
