    ...
    <section class="reports-section">
        <div class="reports-section-header">
            <div>
                ...
                <h2 class="reports-section-title">Reporte de clientes cerrados</h2>
                <p class="reports-section-subtitle">Mantiene el mismo lenguaje visual de consulta_leads y consulta_post_leads, usando exclusivamente los datos de cierres.</p>
            </div>
        ...
        <div class="report-overview-grid">
            <article class="report-chart-card report-chart-card-full">
                <div class="report-chart-header">
                    <div>
                        ...
                        <p class="report-chart-subtitle">Total de clientes cerrados por día dentro del rango seleccionado.</p>
                    </div>
                </div>
            ...
            <div class="report-metric-grid">
                <article class="kpi-card">
                    <div class="kpi-label">Clientes Cerrados</div>
                    <div class="kpi-value" id="kpi-clients-total"><?php echo number_format($leadsCountFiltered); ?></div>
                    <div class="kpi-sub">Cierres contabilizados dentro del período.</div>
                </article>

                <article class="kpi-card">
                    <div class="kpi-label">Origen Conocido</div>
                    <div class="kpi-value" id="kpi-origin-known"><?php echo number_format($clientsConOrigenConocido); ?></div>
                    <div class="kpi-sub"><?php echo formatPercentage($clientsConOrigenConocido, $leadsCountFiltered); ?> del total tiene origen confirmado.</div>
                </article>

                <article class="kpi-card">
                    <div class="kpi-label">Planner Afianzados</div>
                    <div class="kpi-value" id="kpi-wp-afianzados"><?php echo number_format($clientsWpAfianzadosCount); ?></div>
                    <div class="kpi-sub" id="kpi-wp-afianzados-detail"><?php echo formatPercentage($clientsWpAfianzadosCount, $leadsCountFiltered); ?> del total corresponde a WP afianzados.</div>
                </article>

                <article class="kpi-card">
                    <div class="kpi-label">Paquete Cotizado</div>
                    <div class="kpi-value" id="kpi-package-confirmed"><?php echo number_format($clientsPaqueteConfirmado); ?></div>
                    <div class="kpi-sub" id="kpi-package-confirmed-detail"><?php echo formatPercentage($clientsPaqueteConfirmado, $leadsCountFiltered); ?> del total tiene paquete registrado.</div>
                </article>
            </div>
            ...
            <div class="report-breakdown-grid">
                <article class="report-breakdown-card">
                    <div class="report-chart-header">
                        <div>
                            ...
                            <p class="report-chart-subtitle">Distribución del canal con el que terminó cerrando cada cliente.</p>
                        </div>
                    </div>
                    <div class="report-breakdown-list">
                        <?php if (!empty($contactMethodCounts)): ?>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p class="report-breakdown-empty">Sin datos para este período.</p>
                        <?php endif; ?>
                    </div>
                </article>
                ...
                <article class="report-breakdown-card">
                    <div class="report-chart-header">
                        <div>
                            <h3 class="report-chart-title">Origen del cliente</h3>
                            <p class="report-chart-subtitle">Desglose del origen capturado dentro del flujo que terminó en cierre.</p>
                        </div>
                    </div>
                    <div class="report-breakdown-list">
                        <?php if (!empty($howDidYouMeetCounts)): ?>
                            <?php foreach ($howDidYouMeetCounts as $label => $count): ?>
                    ...
                    <div class="report-origin-pending" style="margin-top:10px;">
                        <strong id="report-origin-pending-count"><?php echo number_format($clientsOriginPendingCount); ?> clientes</strong>
                        <span>sin origen confirmado dentro del registro de cierres.</span>
                    </div>
                </article>
                ...
                <article class="report-breakdown-card">
                    <div class="report-chart-header">
                        <div>
                            ...
                            <p class="report-chart-subtitle">Antigüedad declarada por los clientes que sí cerraron.</p>
                        </div>
                    </div>
                    <div class="report-breakdown-list">
                        <?php if (!empty($howLongCounts)): ?>
                            <?php foreach ($howLongCounts as $label => $count): ?>
                                <div class="report-breakdown-item">
                                    <div class="report-breakdown-row">
                                        <div class="report-breakdown-label"><?php echo htmlspecialchars($label, ENT_QUOTES, 'UTF-8'); ?></div>
                                        <div class="report-breakdown-meta"><?php echo number_format($count); ?> · <?php echo formatPercentage($count, $leadsCountFiltered); ?></div>
                ...
                <article class="report-breakdown-card">
                    <div class="report-chart-header">
                        <div>
                            <h3 class="report-chart-title">Campañas</h3>
                            <p class="report-chart-subtitle">Desglose por campaña de origen de los cierres.</p>
                        </div>
                    </div>
                    <div class="report-breakdown-list">
                        <?php if (!empty($campaignCounts)): ?>
                            <?php foreach ($campaignCounts as $label => $count): ?>
                                <div class="report-breakdown-item">
                                    <div class="report-breakdown-row">
                                        <div class="report-breakdown-label"><?php echo htmlspecialchars($label, ENT_QUOTES, 'UTF-8'); ?></div>
                                        <div class="report-breakdown-meta"><?php echo number_format($count); ?> · <?php echo formatPercentage($count, $leadsCountFiltered); ?></div>
            ...
            <!-- <div class="report-insight">
                <div class="report-insight-kicker">Conversión Post-Q a Cliente</div>
                <p class="report-insight-text">→ <span id="report-close-rate"><?php echo number_format($clientsConversionRate, 1); ?>%</span> de los post-calificados terminó en cliente.</p>
                <p class="report-insight-detail" id="report-close-rate-detail"><?php echo number_format($leadsCountFiltered); ?> cierres de <?php echo number_format($leadsPostCountFiltered); ?> sesiones post-calificadas</p>
            </div> -->
        </div>
    </section>
            ...
            <table id="leadsTable" class="efege-table table table-hover">
                ...
                <tbody>
                    ...
                    <tr id="lead-row-<?php echo $lead['id']; ?>-<?php echo htmlspecialchars($lead['tabla_origen']); ?>"
                        ...
                        <td data-column="desde_conoce"><span class="ch-badge"><?php echo htmlspecialchars($knownUsBadgeLabel, ENT_QUOTES, 'UTF-8'); ?></span></td>

                        <!-- Engagement -->
                        <td data-column="engagement">
                            <?php if ($engLabel !== 'N/A' && $engLabel !== 'Sin dato'): ?>
                                <span class="eng-pill <?php echo $engClass; ?>"><?php echo htmlspecialchars($engLabel, ENT_QUOTES, 'UTF-8'); ?></span>
                            <?php else: ?>
                                <span style="color:var(--muted);"><?php echo htmlspecialchars($engLabel, ENT_QUOTES, 'UTF-8'); ?></span>
                            <?php endif; ?>
                        </td>
                        ...
                        <?php if ($tipoUsuario != 4): ?>
                        <!-- Paquete -->
                        <td data-column="paquete"><?php echo $paqOut !== '—' ? '<span class="ch-badge">' . $paqOut . '</span>' : '<span style="color:var(--muted)">—</span>'; ?></td>
                        <?php endif; ?>
