...
<head>
    ...
    <title>Leads Agendados — EFEGE</title>
...
<div class="efege-page">
    ...
    <div class="efege-page-header">
        <div class="efege-page-header-left">
            <div class="efege-page-title"><span class="efege-page-title-sub">Leads Agendados</span></div>
            <div class="efege-page-subtitle">Sesiones agendadas · Plataforma: <strong><?php echo htmlspecialchars($platformLabel); ?></strong></div>
        </div>
        ...
        <div class="filter-bar">
            ...
            <form method="get" id="filterForm" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
                ...
                <a href="consulta_agendados_leads.php?show_all=1" class="efege-btn">
        ...
        <section class="reports-section">
            <div class="reports-section-header">
                <div>
                    ...
                    <p class="reports-section-subtitle">Mantiene la misma estructura de consulta_leads, pero mostrando las sesiones en estatus agendado.</p>
                </div>
            ...
            <div class="report-overview-grid">
                <article class="report-chart-card report-chart-card-full">
                    <div class="report-chart-header">
                        <div>
                            ...
                            <p class="report-chart-subtitle">Solo estatus agendado, atendido, fantasma y muerto dentro del rango seleccionado.</p>
                        </div>
                    </div>
                ...
                <div class="report-metric-grid">
                    <article class="kpi-card">
                        <div class="kpi-label">Leads Agendados</div>
                ...
                <div class="report-breakdown-grid">
                    ...
                    <article class="report-breakdown-card">
                        ...
                        <div class="report-origin-pending" style="margin-top:10px;">
                            ...
                            <span>con origen aun no confirmado dentro del flujo de agendados.</span>
                        </div>
                    </article>
                        ...
                        <div class="report-breakdown-list">
                            <?php if (!empty($postCampaignCounts)): ?>
                                <?php foreach ($postCampaignCounts as $label => $count): ?>
                                    <div class="report-breakdown-item">
                                        <div class="report-breakdown-row">
                                            <div class="report-breakdown-label"><?php echo renderCampaignBadge($label); ?></div>
                                            <div class="report-breakdown-meta"><?php echo number_format($count); ?> · <?php echo formatPercentage($count, $leadsCountFiltered); ?></div>
                                        </div>
                                        <div class="report-breakdown-bar"><span class="report-breakdown-fill" style="width: <?php echo htmlspecialchars(formatPercentage($count, $leadsCountFiltered, 2), ENT_QUOTES, 'UTF-8'); ?>;<?php echo htmlspecialchars(getCampaignBreakdownBarStyleAttr($label), ENT_QUOTES, 'UTF-8'); ?>"></span></div>
                                    </div>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <p class="report-breakdown-empty">Sin datos para este periodo.</p>
