...
if ($filterPlataforma === 'organico') {
    ...
    // Filtrar solo tablas con tipo = 1 (Campaña)
    $sqlTablas = "SELECT nombre FROM tablas_leads WHERE tipo = 1 ORDER BY nombre";
} else {
    // Sin filtro, mostrar todas las tablas
...
<div class="page-heading">
    ...
    <div class="mb-3 row">
        ...
        <div class="mb-3 mb-lg-0 col-12 col-lg-6">
            ...
            <div class="mb-3 card">
                <div class="card-body">
                    <form method="get" class="align-items-end row g-2" id="filterForm">
                        <div class="col-6 col-sm-4">
                            <label class="mb-1 form-label small">Desde</label>
                            <input type="date" name="start_date" class="form-control"
                                value="<?php echo htmlspecialchars($startDate ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                        </div>
                        <div class="col-6 col-sm-4">
                            <label class="mb-1 form-label small">Hasta</label>
                            <input type="date" name="end_date" class="form-control"
                                value="<?php echo htmlspecialchars($endDate ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                        </div>
                        <div class="col-6 col-sm-2">
                            <label class="mb-1 form-label small">Plataforma</label>
                            <select name="filter_plataforma" id="filterPlataforma" class="form-select">
                        ...
                        <div class="d-flex gap-2 col-12 col-sm-2">
                            <button type="submit" class="flex-grow-1 btn btn-primary" title="Filtrar">
            ...
            <div class="row g-3">
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="bg-primary h-100 text-white card stat-card">
                        <div class="d-flex align-items-center justify-content-between p-3 card-body">
                            <div>
                                <div class="opacity-90 mb-1 small">Leads pre qualified hoy <span class="text-white">(<?php echo htmlspecialchars($platformLabel); ?>)</span></div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="bg-success h-100 text-white card stat-card">
                        <div class="d-flex align-items-center justify-content-between p-3 card-body">
                            <div>
                                <div class="opacity-90 mb-1 small">Leads pre qualified totales <span class="text-white">(<?php echo htmlspecialchars($platformLabel); ?>)</span></div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="bg-info h-100 text-white card stat-card">
                        <div class="d-flex align-items-center justify-content-between p-3 card-body">
                            <div>
                                <div class="opacity-90 mb-1 small">Tasa de booking de leads precalificados <span class="text-white">(<?php echo htmlspecialchars($platformLabel); ?>)</span></div>
                                <div class="display-5 fw-bold"><?php echo $tasaConversion; ?>%</div>
                                <div class="opacity-90 mt-2 small">
        ...
        <div class="col-12 col-lg-6">
            <div class="h-100 card">
                <div class="card-body">
                    <h5 class="mb-3 card-title">Tendencia de Leads</h5>
                    <!-- Aquí irá la gráfica -->
    ...
    <section class="section">
        <div class="card">
            <div class="d-flex align-items-center justify-content-between card-header">
                <h5 class="mb-0 card-title">Listado de Leads</h5>
                <div>
                    <button type="button" class="me-2 btn btn-success" data-bs-toggle="modal" data-bs-target="#registroManualModal">
                    ...
                    <table id="leadsTable" class="table table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th data-column="nombre">Nombre del lead</th>
                                <th data-column="fecha">¿Cuándo llegó el lead?</th>
                                <th class="text-center origen-col" data-column="origen">Origen <i class="filter-icon bi bi-funnel" data-column="origen"></i></th>
                                <th class="text-center" data-column="medio">Medio <i class="filter-icon bi bi-funnel" data-column="medio"></i></th>
                                <th class="text-center" data-column="estatus">Estatus <i class="filter-icon bi bi-funnel" data-column="estatus"></i></th>
                                <th data-column="consentimiento">Consentimiento de contacto <i class="filter-icon bi bi-funnel" data-column="consentimiento"></i></th>
                                <th data-column="boda">¿Dónde es la boda?</th>
                                    ...
                                    <?php if ($tipoUsuario != "4"): ?>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($lead['tabla_origen'] === 'organic_leads'): ?>
                                                <?php if ($organicScheduled): ?>
                                                    <button class="d-block w-100 btn btn-success btn-sm" disabled>Ya agendó</button>
                                                <?php else: ?>
                                                    <button class="d-block w-100 btn btn-secondary btn-sm" disabled>N/A</button>
                                                <?php endif; ?>
                                            <?php elseif ($lead['correo_uno_enviado'] == 1): ?>
                                                ...
                                                ?>
                                                <?php if ($opened1): ?>
                                                    <button class="d-block w-100 btn btn-success btn-sm" disabled title="Enviado y abierto">Correo 1
                                                        Enviado <br> <span class="small" style="font-weight: 700;">visto</span></button>
                                                <?php else: ?>
                                                    <button class="d-block w-100 btn btn-secondary btn-sm" disabled
                                                        title="Enviado (no abierto)">Correo 1 Enviado</button>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <button class="d-block w-100 btn btn-primary btn-sm"
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php elseif ($lead['correo_dos_enviado'] == 1): ?>
                                                    ...
                                                    ?>
                                                    <?php if ($opened2): ?>
                                                        <button class="d-block w-100 btn btn-success btn-sm" disabled title="Enviado y abierto">Correo 2
                                                            Enviado <br> <span class="small" style="font-weight: 700;">visto</span></button>
                                                    <?php else: ?>
                                                        <button class="d-block w-100 btn btn-secondary btn-sm" disabled
                                        ...
                                        <td class="gap-2">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <?php if (!empty($cleanPhone) && strlen($cleanPhone) >= 8): ?>
                                                        <?php if (isset($lead['whatsapp_enviado']) && $lead['whatsapp_enviado'] == 1): ?>
                                                            <button class="mb-2 btn btn-success btn-sm whatsapp-btn" title="WhatsApp enviado" style="background-color:#25D366;color:white;border: 1px solid #25D366; margin-right:5px;"><i class="bi bi-whatsapp"></i> WhatsApp<br/><small class="text-muted">enviado</small></button>
                                                        <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                ?>
                                                    <button class="mb-2 btn btn-info btn-sm wa-conversation-btn" data-wa-conversation="1" data-lead-id="<?php echo (int)$lead['id']; ?>" data-tabla="<?php echo htmlspecialchars($lead['tabla_origen'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" title="Ver Conversación de WhatsApp"
            ...
            <div class="modal-body" id="whatsappHistorialBody">
                <div class="wa-wrapper">
                    ...
                    <div class="wa-composer" aria-label="Enviar mensaje (deshabilitado)">
                        <label class="btn-outline-secondary btn wa-clip disabled" title="Adjuntar archivo (deshabilitado)">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <button class="btn-outline-primary btn" type="button" id="btnCopiarLink" title="Copiar link">
                            ...
                            if (response.success) {
                                ...
                                if (rowNode) {
                                    ...
                                    try {
                                        ...
                                        table.cell(rowNode, cellIndex).data('<button class="d-block w-100 btn btn-secondary btn-sm" disabled title="Enviado (no abierto)">Correo 1 Enviado</button>');
                                        table.draw(false);
                                    } catch (e) {
                                        ...
                                        correo1Cell.html('<button class="d-block w-100 btn btn-secondary btn-sm" disabled title="Enviado (no abierto)">Correo 1 Enviado</button>');
                                    }
                                }
                            } else {
                        ...
                        success: function (response) {
                            if (response.success) {
                                ...
                                if (rowNode) {
                                    ...
                                    try {
                                        // Mark as sent but not yet opened (grey) after sending
                                        table.cell(rowNode, cellIndex).data('<button class="d-block w-100 btn btn-secondary btn-sm" disabled title="Enviado (no abierto)">Correo 2 Enviado</button>');
                                        table.draw(false);
                                    } catch (e) {
                                        // fallback to direct DOM update if DataTables call fails
                                        const row = $(`#lead-row-${id}-${tablaOrigen}`);
                                        const correo2Cell = row.find('td:eq(10)');
                                        correo2Cell.html('<button class="d-block w-100 btn btn-secondary btn-sm" disabled title="Enviado (no abierto)">Correo 2 Enviado</button>');
                                    }
                                }
                            } else {
                                showErrorModalFromResponse(response);
            ...
            $.ajax({
                ...
                success: function (resp) {
                    if (resp.success) {
                        ...
                        var correo1Btn = `<button class="d-block w-100 btn btn-primary btn-sm" onclick='enviarPrimerCorreo(${id}, ${JSON.stringify(tablaOrigen)}, ${JSON.stringify(fullName)}, ${JSON.stringify(whenMarried)}, ${JSON.stringify(email)})'>Enviar Correo 1</button>`;
                        var correo2Btn = `<button class="d-block w-100 btn btn-primary btn-sm" onclick='enviarSegundoCorreo(${id}, ${JSON.stringify(tablaOrigen)}, ${JSON.stringify(fullName)}, ${JSON.stringify(whenMarried)}, ${JSON.stringify(email)})'>Enviar Correo 2</button>`;
