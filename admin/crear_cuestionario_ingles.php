...
$sqlCuestionario = "SELECT * FROM cuestionario WHERE id = 2";
  ...
  <div class="modal-dialog modal-lg"> <!-- Se mantiene el tamaño predeterminado -->
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="previewModalLabel">Vista previa del cuestionario en inglés</h5>
...
$(document).ready(function() {
  ...
  function agregarOpciones(cardBody, tipo, opciones = []) {
    ...
    let agregarBoton = $('<button class="btn btn-secondary mt-2" data-tipo-pregunta="' + tipo + '">Agregar Opción</button>');
...
$('#btn-guardar').click(function() {
    ...
    cuestionario.forEach(function(pregunta, index) {
        ...
        if (pregunta.requerida) {
            cardBody.append('<p class="text-danger">* This question is required..</p>');
        }
...
$('#guardarCuestionario').click(function() {
    ...
    type: 'POST',
    data: { cuestionario: JSON.stringify(cuestionarioGenerado), id:2 },  // Convertir el array a JSON
