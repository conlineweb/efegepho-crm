       ...
       <h1 class=" mt-5 text-center">INQUIRE</h1>
        <form id="weddingForm" class="form-wrapper">
            <?php if (!empty($lead_data)):
                ...
                $pref_wedding_date = htmlspecialchars($ld['when_are_you_getting_married?'] ?? '', ENT_QUOTES);
                ...
                <input type="hidden" name="wedding_location"
                    value="<?php echo htmlspecialchars($ld['where_is_your_marriage_taking_place_'] ?? '', ENT_QUOTES); ?>">
                <input type="hidden" name="how_long_known_us"
                    value="<?php echo htmlspecialchars($ld['how_long_known_us'] ?? '', ENT_QUOTES); ?>">
        ...
        if (weddingForm) {
            ...
            form.addEventListener("submit", function (event) {
                ...
                if (debugNoSave) {
                    ...
                    // compute client time from vendor time (vendor = Mexico City UTC-6)
                    ...
                    Swal.fire({
                        ...
                        html: `
                          <strong>Vendor (Mexico City / server)</strong>: ${vendorTime} (${vendorAMPM})<br>
