...
<head>
  ...
  <style>
    ...
    /* hide language tab switcher */
    #lang-tab-switcher { display: none !important; }
  </style>
</head>
...
<body>
  <div class="py-2 container">
    ...
    <div class="d-flex aling-items-center justify-content-between">
      <ul class="mb-3 nav nav-pills" id="lang-tab-switcher" role="tablist">
  ...
  <script>
    // Declare editors object *outside* the forEach loop
    const editors = {};
    const textareas = document.querySelectorAll('textarea[id^="txtCliRegEsp"], textarea[id^="txtAdminRegEsp"],textarea[id^="txtCliRegAutoEsp"], textarea[id^="txtCliRegAutoEng"],  textarea[id^="txtVendRegEsp"], textarea[id^="txtCliRegEng"], textarea[id^="txtAdminRegEng"], textarea[id^="txtVendRegEng"]');

    textareas.forEach(textarea => {
      ClassicEditor
        .create(textarea)
        .then(editor => {
          editors[textarea.id] = editor; // Store the editor instance
        })
        .catch(err => {
