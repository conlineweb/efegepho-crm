...
// Excluir muertos de todas las etapas
$preStage = array_values(array_filter($preStage, function($l) { return ($l['_status'] ?? '') !== 'muerto'; }));
$postStage = array_values(array_filter($postStage, function($l) { return ($l['_status'] ?? '') !== 'muerto'; }));
