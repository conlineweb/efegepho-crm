            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select name="how_long_known_us" required>
                        ...
                        <option value="Between 3 months and 1 year">Between 3 months and 1 year</option>
            ...
            <div class="row g-4">
                <div class="col-12">
                    ...
                    <select id="first_contact_channel" name="first_contact_channel" required>
                        <option value="" disabled selected>How did they reach us?</option>
                        <option value="WhatsApp">WhatsApp</option>
                        <option value="Instagram DM – Campaign">Instagram DM – Campaign</option>
                        <option value="Instagram DM – Organic">Instagram DM – Organic</option>
        ...
        <div id="plannerFormContainer">
            <form id="weddingPlannerForm" class="form-wrapper">
                ...
                <div class="row g-4 mt-1 mb-5">
                    <div class="col-12">
                        <label class="form-label">First contact channel</label>
                        <select id="planner_first_contact_channel" name="first_contact_channel" required>
                            <option value="" disabled selected>How did they reach us?</option>
                            <option value="WhatsApp">WhatsApp</option>
                            <option value="Instagram DM – Campaign">Instagram DM – Campaign</option>
                            <option value="Instagram DM – Organic">Instagram DM – Organic</option>
...
<!-- Removed geo_timezone.js: timezone is now obtained from Date.getTimezoneOffset() only -->
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (weddingForm) {
            ...
            form.addEventListener("submit", async function (event) {
                ...
                // Compute timezone info from device (Intl + offset). No dependency on geo_timezone.js
                const tzName = (typeof Intl !== 'undefined' && Intl.DateTimeFormat) ? Intl.DateTimeFormat().resolvedOptions().timeZone : '';
                const confirmedTZ = {
                    timezone_name: tzName || `UTC${timezone >= 0 ? '+' : ''}${timezone}`,
                ...
                formData.append('first_contact_channel', $('#first_contact_channel').val());
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (serverData.success == "full") {
                            ...
                            const errorIcon = data.icon || "error"; // warning para validación, error para sistema
                            Swal.fire({
